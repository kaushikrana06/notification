...
public class CallsActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        packageName = Util.getCallPackage(getApplicationContext());
        ...
        boolean isAppInstalled = Util.appInstalledOrNot(this, packageName);
        if (isAppInstalled) {
            update();
            //ADS+Firebase
    ...
    private void update() {
        GmailAdapter adapter = new GmailAdapter(this, packageName);
