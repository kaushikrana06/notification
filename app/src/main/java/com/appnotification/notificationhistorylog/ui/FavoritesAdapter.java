...
public class FavoritesAdapter extends RecyclerView.Adapter<BrowseViewHolder> {
    ...
    FavoritesAdapter(Activity context) {
    ...
    private void loadMore(long afterId) {
        ...
        try {
            ...
            Cursor cursor = db.query(DatabaseHelper.PostedEntry.TABLE_NAME,
                    ...
                    DatabaseHelper.PostedEntry.COLUMN_NAME_FAVORITE + "= ?",
