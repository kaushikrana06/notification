...
public class InstaActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isAppInstalled = Util.appInstalledOrNot(this, Util.PACKAGE_INSTAGRAM);
        if (isAppInstalled) {
            update();
            //ADS+Firebase
    ...
    private void update() {
        GmailAdapter adapter = new GmailAdapter(this, Util.PACKAGE_INSTAGRAM);
