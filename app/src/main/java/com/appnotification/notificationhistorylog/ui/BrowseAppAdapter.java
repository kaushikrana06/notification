...
class BrowseAppAdapter extends RecyclerView.Adapter<BrowseViewHolder> {

    private final static int LIMIT = Integer.MAX_VALUE;
    private final static String PAGE_SIZE = "19999";
    ...
    BrowseAppAdapter(Activity context) {
        ...
        DataItem(Context context, long id, String str) {
            ...
            try {
                ...
                if (!iconCache.containsKey(packageName)) {
                    Drawable drawable = Util.getAppIconFromPackage(context, packageName);
                    if (drawable != null)
